...
@Getter@Setter
public class BPA0005VO extends ApiCommonVO{

	@NotNull(message="validate.required.value")
	@NotEmpty(message="validate.required.value")
    @Size(max=1, message="validate.size")
	@Pattern(regexp="^(1|2|3)$", message="validate.pattern")
	private String jobCd;	//요청업무구분 1:로그인비밀번호, 2:캐시결제비밀번호, 3:임시비밀번호
	...
	public String toString() {
		return "BPA0005VO [jobCd=" + jobCd + ", userNo=" + userNo + ", userPasswd=" + userPasswd
